...
{
    public partial class PortableBattery : Form
    {
        ...
        private void InsertInfo(ref ListView lst, bool DontInsertNull)
        {
            ...
            ManagementObjectSearcher searcher = new ManagementObjectSearcher("select * from  Win32_PortableBattery");
        ...
        private void PortableBattery_Load(object sender, EventArgs e)
        {
