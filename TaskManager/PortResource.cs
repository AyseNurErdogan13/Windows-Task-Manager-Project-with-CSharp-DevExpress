...
{
    public partial class PortResource : Form
    {
        public PortResource()
        {
            InitializeComponent();
        ...
        private void InsertInfo(ref ListView lst, bool DontInsertNull)
        {
            ...
            ManagementObjectSearcher searcher = new ManagementObjectSearcher("select * from  Win32_PortResource");
        ...
        private void PortResource_Load(object sender, EventArgs e)
        {
