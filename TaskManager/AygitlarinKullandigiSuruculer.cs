...
{
    public partial class AygitlarinKullandigiSuruculer : Form
    {
        public AygitlarinKullandigiSuruculer()
        {
            InitializeComponent();
        }
          ...
          private void InsertInfo(ref ListView lst, bool DontInsertNull)
        {
            ...
            ManagementObjectSearcher searcher = new ManagementObjectSearcher("select * from  Win32_CIMLogicalDeviceCIMDataFile");
        ...
        private void AygitlarinKullandigiSuruculer_Load(object sender, EventArgs e)
        {
