...
{
    public partial class IRQKesmeleri : Form
    {
        public IRQKesmeleri()
        {
            InitializeComponent();
        ...
        private void InsertInfo(ref ListView lst, bool DontInsertNull)
        {
            ...
            ManagementObjectSearcher searcher = new ManagementObjectSearcher("select * from  Win32_IRQResource");
        ...
        private void IRQKesmeleri_Load(object sender, EventArgs e)
        {
